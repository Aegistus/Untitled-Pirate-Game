...
{
    [SerializeField]
    public Color outlineColor = new Vector4(0.6f, 0.2f, 0.2f);
    private Color playerColor = new Vector4(0.1f, 0.3f, 0.6f);
    private Color enemyColor = new Vector4(0.6f, 0.2f, 0.2f);
    ...
    private float universalWidth = 5f;

    [SerializeField]
    public bool overrideDefaultWidth = false;
    ...
    void Awake()
    {
        if (!overrideDefaultColor)
        {
            if (gameObject.layer == 3)
                ...
                outlineColor = enemyColor;
        }

        if (!overrideDefaultWidth)
            outlineWidth = universalWidth;
        ...
        outlineMaskMaterial =
            Instantiate(Resources.Load<Material>(@"Materials/OutlineMask"));
        outlineFillMaterial =
    ...
    void OnValidate()
    {
        ...
        if (
            !precomputeOutline && bakeKeys.Count != 0 ||
    ...
    void LoadSmoothNormals()
    {
        ...
        )
        {
            ...
            skinnedMeshRenderer.sharedMesh.uv4 =
                new Vector2[skinnedMeshRenderer.sharedMesh.vertexCount];
